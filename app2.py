...
st.sidebar.markdown("## The piechart And Barchart: Relationship Between And Sales.")
...
st.markdown("Analyzing the Relationship Between Customer and Other Attributes like(Total bill,Tips,Gender)with Each Day.")
